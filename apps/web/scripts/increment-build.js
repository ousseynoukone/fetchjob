...
const root = 'C:\\Users\\ousse\\Desktop\\perso project\\findurjob-clone';
const buildInfoPath = path.join(root, 'apps', 'web', 'lib', 'build-info.json');
...
let gitSha = '';
try {
  gitCount = parseInt(execSync('git rev-list --count HEAD', { cwd: root, encoding: 'utf8' }).trim(), 10);
